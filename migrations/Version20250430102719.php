 ...
 */
final class Version20250430102719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventory (id INT AUTO_INCREMENT NOT NULL, inventory_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', inventory_closed TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_movement (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, last_qty INT NOT NULL, new_qty INT NOT NULL, INDEX IDX_3F6DFF604584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_reception (id INT AUTO_INCREMENT NOT NULL, invoice_ref VARCHAR(50) NOT NULL, parcel_ref VARCHAR(50) NOT NULL, product_reception_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock_modification (id INT AUTO_INCREMENT NOT NULL, stock_modification_message LONGTEXT NOT NULL, stock_modification_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stock_transfert (id INT AUTO_INCREMENT NOT NULL, linked_transfert_id INT NOT NULL, stock_transfert_message LONGTEXT NOT NULL, stock_transfert_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_86D34A5392A50EF7 (linked_transfert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
