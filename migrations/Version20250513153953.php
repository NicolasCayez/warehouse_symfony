 ...
 */
final class Version20250513153953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_transfert ADD linked_transfert_id INT DEFAULT NULL, CHANGE linked_stock_transfert_id linked_stock_transfert_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_transfert DROP linked_transfert_id, CHANGE linked_stock_transfert_id linked_stock_transfert_id INT DEFAULT NULL');
    }
}
