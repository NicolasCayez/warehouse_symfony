 ...
 */
final class Version20250306093057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventory (id INT NOT NULL, inventory_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', inventory_closed TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE movement (id INT AUTO_INCREMENT NOT NULL, warehouse_id INT NOT NULL, movement_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', movement_type VARCHAR(255) NOT NULL, INDEX IDX_F4DD95F75080ECDE (warehouse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_movement (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, movement_id INT NOT NULL, last_qty INT NOT NULL, new_qty INT NOT NULL, INDEX IDX_3F6DFF604584665A (product_id), INDEX IDX_3F6DFF60229E70A7 (movement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product_reception (id INT NOT NULL, invoice_ref VARCHAR(50) NOT NULL, parcel_ref VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock_modification (id INT NOT NULL, stock_modification_message LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stock_transfert (id INT NOT NULL, linked_transfert_id INT NOT NULL, stock_transfert_message LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_86D34A5392A50EF7 (linked_transfert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, supplier_name VARCHAR(50) NOT NULL, supplier_phone VARCHAR(13) DEFAULT NULL, supplier_address_number INT DEFAULT NULL, supplier_address_road VARCHAR(50) DEFAULT NULL, supplier_address_label VARCHAR(50) DEFAULT NULL, supplier_address_postal_code VARCHAR(8) DEFAULT NULL, supplier_address_city VARCHAR(50) DEFAULT NULL, supplier_address_state VARCHAR(50) DEFAULT NULL, supplier_address_country VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, user_last_name VARCHAR(50) NOT NULL, user_first_name VARCHAR(50) NOT NULL, user_phone VARCHAR(13) DEFAULT NULL, user_address_number INT DEFAULT NULL, user_address_road VARCHAR(50) DEFAULT NULL, user_address_label VARCHAR(50) DEFAULT NULL, user_address_postal_code VARCHAR(8) DEFAULT NULL, user_address_city VARCHAR(50) DEFAULT NULL, user_address_state VARCHAR(50) DEFAULT NULL, user_address_country VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE movement ADD CONSTRAINT FK_F4DD95F75080ECDE FOREIGN KEY (warehouse_id) REFERENCES warehouse (id)');
        ...
        $this->addSql('ALTER TABLE product_movement ADD CONSTRAINT FK_3F6DFF60229E70A7 FOREIGN KEY (movement_id) REFERENCES movement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movement DROP FOREIGN KEY FK_F4DD95F75080ECDE');
        ...
        $this->addSql('ALTER TABLE product_movement DROP FOREIGN KEY FK_3F6DFF60229E70A7');
